...
import Eccom from '../public/assets/projects/utibuapp.jpeg';
    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Utibu App</h2>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p>
            This app was built using Javascript(React NAtive).Recurrent users with chronic conditions can schedule their drug collections/orders and new users
            can also orders drugs and get their orders to the pharmacy. 
          </p>
          <a
            href='https://github.com/Nkunja/Utibu-App'
            target='_blank'
            rel='noreferrer'
          >
