      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            accessing API endpoints.  This application showcases available travel destinations and the capability
            to book them and start your travel.
          </p>
          <a
            href='https://github.com/Nkunja/ReactTravelApp'
            target='_blank'
            rel='noreferrer'
          >
