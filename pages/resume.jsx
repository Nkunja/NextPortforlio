  ...
  return (
    <>
      ...
      <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
        ...
        <p>
          Analytical, innovative, motivated and self-driven web development professional
          with the desire to grow and learn more on team leadership and
        ...
        <div className='py-6'>
          ...
          <li>
              Developed well responsive web applications majoring on front end technologies such as React JS and Next JS and backend
